...
const features = [
  {
    title: 'Native shell',
    description: 'Tauri v2 keeps the desktop wrapper fast and lightweight.',
    icon: 'i-lucide-box',
  },
  {
    title: 'SolidJS UI',
...
function App() {
  const [meta] = createResource(async () => invoke<WorkspaceMeta>('workspace_meta'))
    ...
    <main class="min-h-screen py-10 text-white">
      <div class="stack-shell flex flex-col gap-6">
          ...
          <div class="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div class="max-w-2xl space-y-4">
              ...
              <h1 class="text-4xl font-semibold tracking-tight sm:text-5xl">
                Native shell, same elegant repo.
              </h1>
              <p class="stack-muted">
                This app demonstrates the Tauri v2 + SolidJS lane of the template and keeps a small
                native command bridge ready for expansion.
              </p>
            </div>

            <div class="stack-panel min-w-[260px] p-5">
              <p class="stack-label">Tauri bridge</p>
        ...
        <section class="stack-panel grid gap-4 px-6 py-6 text-sm text-white/68 md:grid-cols-3">
          ...
          <div>
            <p class="stack-label">Native</p>
            <p class="mt-3 font-mono text-white">cd apps/desktop && bun run tauri dev</p>
          </div>
          <div>
